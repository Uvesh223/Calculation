          ...
          <ScrollView
            ...
            <View style={{ marginBottom: 30 }}>
              <View style={{ paddingVertical: 30, justifyContent: 'center', alignItems: 'center' }}>
                ...
                <View>
                  <Text style={[c.normalText,{paddingVertical:0,fontSize: 17,}]}>Version: 1.1.12</Text>
                </View>
                <TouchableOpacity onPress={() => Linking.openURL('http://www.calculation.com')}>
                  <Text style={[c.normalText,{ color: 'blue',textDecorationLine:'underline',paddingVertical:0,fontSize: 17}]}>
                    www.calculation.com
                  </Text>
                </TouchableOpacity>
                <View style={{flexDirection:'row',justifyContent:'center',alignItems:'center'}}>
                <Icon name={'mail'} size={15} style={{marginRight:5}}/>
                  <Text style={[c.normalText,{paddingVertical:0,fontSize: 17}]}>calculation@gmail.com</Text>
                </View>
                <View style={{flexDirection:'row',justifyContent:'center',alignItems:'center'}}>
                  <Icon name={'phone-call'} size={15} style={{marginRight:5}}/>
                  <Text style={[c.normalText,{paddingVertical:0,fontSize: 17}]}>1900 425 6235</Text>
                </View>
              </View>
              <View>
              </View>
